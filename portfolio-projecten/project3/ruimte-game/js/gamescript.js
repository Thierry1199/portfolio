...
function initGame() {
	// Als er een bestaande speler is, bewaar dan de snelheid
	const existingSpeed = player ? player.speedX : 3;
	
	player = new Player(10, canvasHeight/2);
	// Zorg dat de snelheid hetzelfde blijft als het vorige level
	player.speedX = existingSpeed;
	player.currentSpeed = existingSpeed;
